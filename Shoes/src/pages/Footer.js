...
const Footer = () => {
  return (
    <div className="py-12 px-4 text-white bg-blue-gray flex flex-col items-center gap-12 text-center lg:p-20">
      <div className="lg:flex lg:items-center lg:justify-between w-full lg:text-left">
        <ul>
        ...
        <ul className="flex flex-col gap-2 items-center lg:text-left lg:items-start">
      ...
      <hr className="w-full " />
      <ul className="flex flex-col items-center gap-6 lg:flex-row lg:w-full lg:justify-between">
